                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            <a class="nav-link" href="{{ route ('perfilusuario')}}"><i class="fa fa- user"></i>Mi perfil</a>
                            <!-- -- -->
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h2 class="box-title">Formato de Solictud </h2><br>
                                    ...
                                    <div class="animated fadeIn">
                                        <div class="row">
                                            <div class="col-xs-6 col-sm-6">
                                                <form method="POST" action="{{ route('guardartareas') }}">
                                                    @csrf
                                                    <div class="card">
                                                        <form>
                                                        ...
                                                        <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    <div class="input-group-addon"><i class="fa fa-user"></i></div>
                                                                        <select class="form-control" tabindex="1" name="personal_tarea" required>
                                                                            ...
                                                                            <option value="Direccion de Comercializacion">Direccion de Comercializacion</option>
                                                                            <option value="Direccion de Planeacion y Proyectoa">Direccion de Planeacion y Proyectoa</option>
                                                                            <option value="Juridico">Juridico</option>
                                                                            <option value="Contraloria">Contraloria</option>
                                                                            <option value="Uippe">Uippe</option>
                                                                            <option value="Cumplimiento Normativo y Transparencia">Cumplimiento Normativo y Transparencia</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input class="form-control" placeholder="" name="nombre_tarea" required>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class=" form-control-label" >Descripción de la tarea.</label>
                                                                    <div class="input-group">
                                                                        <div class="input-group-addon"><i class="fa fa-pencil"></i></div>
                                                                        <textarea cols="100" rows="10" name="descripcion_tarea"></textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    <label class=" form-control-label" >Hora de entrega</label>
                                                                    <div class="input-group">
                                                                        <div class="input-group-addon"><i class="fa fa-clock"></i></div>
                                                                        <input type="time" class="form-control" name="hora_tarea" required>
                                                                    </div>
                                                                </div>
                                                                <center>
                                                    ...
                                                    <div class="col-xs-6 col-sm-6">
                                                        <div class="card">
                                                            <div class="card-header">
                                                                <strong class="card-title">Datos de Tareas</strong>
                                                            </div>
                                                            <div class="card-body">
                                                                <div class="table-responsive">
                                                                    <table class="table table-hover">
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                <th scope="row">{{$tareas->nombre_tarea}}</th>
                                                                                <th scope="row">{{$tareas->created_at->diffForHumans()}}</th> 
                                                                                @if($fecha_act->diffInDays($tareas->fecha_tarea) == 0)
                                                                                    @if($fecha_act->diffInHours($tareas->hora_tarea) == 0)
                                                                                        @if($hora->diffInMinutes($tareas->created_at) == 0)
                                                                                            <th scope="row"><img src="images/danger.gif" width="30" height="30"/>plazo vencido</th>
                                                                                        @else
                                                                                            <th scope="row"><img src="images/danger.gif" width="30" height="30"/>{{$hora->diffInMinutes($tareas->created_at)}} minutos</th>
                                                                                        @endif
                                                                                    @else
                                                                                        <th scope="row"><img src="images/danger.gif" width="30" height="30"/>{{$hora->diffInHours($tareas->hora_tarea)}} Horas</th>        
                                                                                    @endif
                                                                                @else
                                                                                    @if($fecha_act->diffInDays($tareas->fecha_tarea) == 1) 
                                                                                        <th scope="row"><img src="images/error.gif" width="30" height="30"/>{{$fecha_act->diffInDays($tareas->fecha_tarea)}} Dias</th> 
                                                                                    @else
                                                                                        <th scope="row"><img src="images/carga.gif" width="30" height="30"/>{{$fecha_act->diffInDays($tareas->fecha_tarea)}} Dias</th> 
                                                                                    @endif
                                                                                @endif
                                                                                <th scope="row">
                                                                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#detalletarea{{$tareas->id_tareas}}">
                                                                                        Ver detalles
                                                                                    </button>
                                                                                    <!-- Modal -->
                                                                                    <div class="modal fade" id="detalletarea{{$tareas->id_tareas}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                                                                                        <div class="modal-dialog" role="document">
                                                                                            ...
                                                                                            <center>
                                                                                                <h5>Nombre de la tarea: </h5>{{$tareas->nombre_tarea}}
                                                                                                <br><br>
                                                                                                <h5>Descripcion de la tarea: </h5>{{$tareas->descripcion_tarea}}
                                                                                                <br><br>
                                                                                                <h5>Aquien va dirigido: </h5>{{$tareas->personal_tarea}}
                                                                                                <br><br>
                                                                                                @if($fecha_act->diffInDays($tareas->fecha_tarea) == 0)
                                                                                                <h5>Fecha de entrega: </h5><img src="images/danger.gif" width="30" height="30"/> plazo vencido 
                                                                                                @else
                                                                                                <h5>Fecha de entrega: </h5>{{$tareas->fecha_tarea}}
                                                                                                @endif
                                                                                                <br><br>
                                                                                                @if($hora->diffInMinutes($tareas->hora_tarea) == 0)
                                                                                                <h5>Fecha de entrega: </h5><img src="images/danger.gif" width="30" height="30"/> plazo vencido 
                                                                                                @else
                                                                                                <h5>Hora de entrega: </h5>{{$tareas->hora_tarea}}
                                                                                                @endif
                                                                                                <br><br>
                                                                                            </center>
                                                                                            </div>
