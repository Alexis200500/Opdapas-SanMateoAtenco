                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h1 class="box-title">Estado de solicitudes</h1><br>
                                <h5></h5>
                            </div>
                            <center>
                                            ...
                                            @foreach($mis_solicitudes as $solicitud)
                                                <tr>
                                                    ...
                                                    @else
                                                        ...
                                                        @endif
                                                    @endif
                                                    <td><a type="button" class="btn btn-danger" href="{{ route('pdf', $solicitud->id_solicitud) }}" target="_blank"><i class="fa fa-file-text"></i> PDF</a></td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
