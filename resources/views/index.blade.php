                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-md-12">
                                                <div class="thumbnail">
                                                    ...
                                                    <div class="caption">
                                                        <center>
                                                            <h3>Solicitud de pipas</h3>
                                                            <p>Para solicitar una pipa da clic en el siguiene boton y llena el formulario</p>
                                                            <p>
                                                                <a href="{{url('/solicitarpipa')}}" class="btn btn-primary" role="button">Ir</a>
                                                            </p>
                                                        </center>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="thumbnail">
                                                    ...
                                                    <div class="caption">
                                                        <center>
                                                            ...
                                                            <p>Para solicitar material da clic en el siguiene boton y llena el formulario</p>
                                                            <p>
                                                                <a href="{{url('/solicitudm')}}" class="btn btn-primary" role="button">Ir</a>
                                                            </p>
                                                        </center>
                                                    </div>
                                                </div>
