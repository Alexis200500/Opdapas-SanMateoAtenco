                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-deck">
                                <div class="card">
                                    @foreach($oficio as $oficio)
                                        @switch($datos_usuario->roluser)
                                        
                                            @case("user1")
                                                @if($oficio->usuario2_oficio == "Si")
                                                    <div class=" card text-white bg-success mb-3" style="max-width: 18rem;">
                                                        <div class="card-header">Completado</div>
                                                        <div class="card-body">
                                                            <h5 class="card-title">{{$oficio->lugar_y_fecha}}</h5>
                                                            <p class="card-text"></p>
                                                        </div>
                                                    </div>
                                                    @else
                                ...
                                <div class="card">
                                    <div class="card text-white bg-info mb-3" style="max-width: 18rem;">
                                        ...
                                        <div class="card-body">
                                            <h5 class="card-title">San mateo atenco </h5>
                                            <p class="card-text"></p>
                                        </div>
                                    </div>                               
                                </div>
                                <div class="card">
                                    @foreach($oficios as $oficios)
                                        @switch($datos_usuario->roluser)
                                            ...
                                            @case("user1")
                                                @if($oficios->fecha_limite_oficio == $tiempo)
