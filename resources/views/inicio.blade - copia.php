                                                        ...
                                                        <div class="card-body card-block">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input class="form-control" placeholder="Ej: Emmanuel Campos Genaro" name="nombre_completo_solicitud" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input class="form-control" placeholder="Ej: 7221234567" name="telefono_solicitud" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input class="form-control" placeholder="Ej: San Mateo Atenco, CP 1234." name="nombre_domicilio_solicitud" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input class="form-control" placeholder="Ej: Francisco I Madero" name="calle_solicitud" required>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input class="form-control" placeholder="10" name="numero_domicilio_solicitud" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="card-body">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <table>
                                                                            <tr>
                                                                                ...
                                                                                <th><input type="radio" name="status_detalle" value="Entegrado" required>Entregado  <br></th>
                                                                            </tr>
                                                                        </table>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <select class="form-control" tabindex="1" name="id_tipo_solicitud" required>
                                                                            <option disabled>Selecciona una opción.</option>
                                                                                @foreach ($tipo_solicituds as $tipo_solicitud)
                                                                            <option value={{$tipo_solicitud->id_tipo_solicitud}}>{{$tipo_solicitud->nombre_tipo}}</option>
                                                                                @endforeach
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input class="form-control" name="litros_detalle" required>
                                                                    </div>
                                                                </div>
                                                                <center>
