                                    ...
                                    <nav id="dropdown">
                                        <ul class="mobile-menu-nav">
                                            ...
                                            <li class="">
                                                ...
                                                <ul class="submenu-angle" aria-expanded="true">
                                                    <li><a title="Opcion 1" href="{{url('/home')}}"><span class="mini-sub-pro">Solictar pipa</span></a></li>
                                                    <!-- <li><a title="Opcion 2" href="{{url('/solicitudm')}}"><span class="mini-sub-pro">Solicitar material</span></a></li> -->
                                                    <li><a title="Opcion 3" href="{{url('/solicitud')}}"><span class="mini-sub-pro">Mis solicitudes</span></a></li>
                                                </ul>
                                            </li>
                                    ...
                                    <div class="row">
                                        <div class="breadcomb-wp">
                                            <div class="breadcomb-ctn">
                                                <h2>Solicitud de Pipa de Agua.</h2>
                                                    ...
                                                    <div class="col-xs-6 col-sm-6">
                                                        <form method="POST" action="{{ route('guardarSolicitud') }}">
                                                            ...
                                                            <div class="col-xs-6 col-sm-6">
                                                                <div class="card">
                                                                    <div class="card-header">
                                                                        <h4 class="card-title">Datos de Solicitud</h4>
                                                                        <hr>
                                                                    </div>
                                                                    <div class="card-body">
                                                                        <div class="form-group">
