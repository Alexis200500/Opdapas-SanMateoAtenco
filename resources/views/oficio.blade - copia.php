                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h2 class="box-title">Generador de oficios</h2>{{-- <br> --}}
                            </div>
                            <div class="row">
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="animated fadeIn">
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-12">
                                                <form method="POST" action="{{route('guardaroficio')}}">
                                                    @csrf
                                                    <div class="card">
                                                        <form>
                                                        <div class="card-header">
                                                            <strong>Datos del oficio</strong>
                                                        </div>
                                                        <div class="card-body card-block">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input class="form-control" placeholder="Ej: San Mateo Atenco, Estado de México a 17 de enero de 2022" name="lugar_y_fecha" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class=" form-control-label">Numero de oficio</label>
                                                                <div class="input-group">
                                                                    <div class="input-group-addon"><i class="fa fa-hashtag"></i></div>
                                                                    <input class="form-control" placeholder="Ej: *" name="numero_oficio" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input class="form-control" placeholder="Ej: El que se indica" name="asunto" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class=" form-control-label">Contenido del oficio.</label>
                                                                <div class="input-group">
                                                                    <div class="input-group-addon"><i class="fa fa-pencil"></i></div>
                                                                        <textarea cols="100" rows="10" name="contenido"></textarea>
                                                                    </div>
                                                                </div>                                                                                                                            
                                                            </div>
                                                            <center>
                                                                <button type="submit" class="btn btn-primary btn-md btn-block col-sm-2">Generar oficio</button>
                                                            </center>
                                                        </div>
                                                    </div>
