                                                            ...
                                                            <div class="card">
                                                                ...
                                                                <div class="card-body card-block">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">
                                                                            <div class="input-group-addon"><i class="fa fa-pencil"></i></div>
                                                                            <textarea cols="50" rows="10" name="descripcion_tarea"></textarea>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                                                    ...
                                                                                                    <div class="modal-content">
                                                                                                        ...
                                                                                                        <div class="modal-body">
                                                                                                            <center>
                                                                                                                ...
                                                                                                                <br><br>
                                                                                                                @if($fecha_act->diffInDays($tareas->fecha_tarea) == 0)
                                                                                                                <h5>Fecha de entrega: </h5><img src="images/danger.gif" width="30px" height="30px"/> plazo vencido 
                                                                                                                @else
